...
export const AddTodo = ({addTodo}) => {
  ...
  return (
    ...
    <div className="mb-3">
      <label htmlFor="title" className="form-label">New To-Do Title</label>
    ...
    <div className="mb-3">
      ...
      <input type="text" vlaue={desc} onChange={(e)=>{setDesc(e.target.value)}} className="form-control" id="desc"/>
    </div>
